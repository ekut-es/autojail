...
.cell = {
	...
	/*RAM 1 0xfbfea000-0xfbffa000*/	{
		...
		.virt_start = 0x0,
		.size = 0x10000,
		.flags = JAILHOUSE_MEM_READ|JAILHOUSE_MEM_WRITE|JAILHOUSE_MEM_EXECUTE|JAILHOUSE_MEM_LOADABLE|JAILHOUSE_MEM_ROOTSHARED,
	},
	/*RAM 2 0xf3fea000-0xfbfea000*/	{
		.phys_start = 0xf3fea000,
		.virt_start = 0x30000000,
		.size = 0x8000000,
		.flags = JAILHOUSE_MEM_READ|JAILHOUSE_MEM_WRITE|JAILHOUSE_MEM_EXECUTE|JAILHOUSE_MEM_DMA|JAILHOUSE_MEM_LOADABLE|JAILHOUSE_MEM_ROOTSHARED,
	},
	...
	/*communication_region 0xf3fe9000-0xf3fea000*/	{
		...
		.size = 0x1000,
		.flags = JAILHOUSE_MEM_READ|JAILHOUSE_MEM_WRITE|JAILHOUSE_MEM_COMM_REGION|JAILHOUSE_MEM_ROOTSHARED,
	},
