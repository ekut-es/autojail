...
.cell = {
	...
	/*System RAM 0x80000-0x3b400000*/	{
		...
		.virt_start = 0x80000,
		.size = 0x3b380000,
		.flags = JAILHOUSE_JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE | JAILHOUSE_MEM_EXECUTE,
	},
	/*fd500000.pcie 0xfd500000-0xfd509310*/	{
		.phys_start = 0xfd500000,
		.virt_start = 0xfd500000,
		.size = 0x9310,
		.flags = JAILHOUSE_JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE | JAILHOUSE_MEM_IO | JAILHOUSE_MEM_IO_8 | JAILHOUSE_MEM_IO_16 | JAILHOUSE_MEM_IO_32 | JAILHOUSE_MEM_IO_64,
	},
